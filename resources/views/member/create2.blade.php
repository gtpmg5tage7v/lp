...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">a01</a>
</nav>

<!-- FV -->
<div class="container-fluid">
  <h1 class="text-center">a01</h1>
  <img src="{{ asset('img/a01.png') }}" class="img-fluid" alt="">
  </div>
...
<div class="container">
  ...
  @csrf
  <!-- valueに広告コードを入れる　-->
  <input type="hidden" name="advertisingcode" value="a01">
