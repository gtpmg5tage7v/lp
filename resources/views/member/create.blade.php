...
<nav class="navbar navbar-light bg-light">
  <a class="navbar-brand" href="#">a09</a>
</nav>

<!-- FV -->
<div class="container-fluid">
  <h1 class="text-center">a09</h1>
  <img src="{{ asset('img/a09.png') }}" class="img-fluid" alt="">
  </div>
...
<div class="container">
  ...
  <input type="hidden" name="advertisingcode" value="a09">
